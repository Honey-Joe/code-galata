  ...
  return (
    <div className="2xl:container py-8">
      <div className="w-[90%] mx-auto grid grid-cols-1">
        <div className="">
          <h1 className="text-[18px] text-blue-600 text-center">What we Provides?</h1>
          <h2 className="text-[42px] font-semibold text-center">
            Provide Interective IT Solution Business Services
          </h2>
          <div className="my-5">
          <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 justify-center">
